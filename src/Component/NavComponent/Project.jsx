      ...
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-black mb-4 tracking-tight">
            Tested <span className="text-blue-500">Projects</span>
          </h2>
          ...
          <p className="text-lg text-gray-100 max-w-2xl mx-auto font-medium">
            Real-world QA work across fintech, healthcare, and e-commerce
            platforms — from functional testing to defect tracking and UAT.
          </p>
        </motion.div>
