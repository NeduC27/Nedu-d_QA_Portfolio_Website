...
function Home() {
  return (
    <Container /*maxWidth="lg"*/ className="px-0 py-20">
      ...
      >
        <Box className="relative min-h-[75vh] flex items-center shadow-2xl bg-gray-200 rounded-[2.5rem] overflow-hidden border border-blue-600 /*blueprint-grid1*/">
          ...
          >
            ...
            <Box className="flex-1 text-center md:text-left">
              <motion.div variants={itemVariants}>
                <Typography
                  variant="overline"
                  className="font-bold text-blue-800 tracking-[0.3em] text-xs md:text-sm uppercase mb-2 block"
                >
                  Technical Portfolio
                </Typography>
              </motion.div>
              ...
              <motion.div variants={itemVariants}>
                <Typography className="mb-10 font-medium text-gray-800 max-w-lg mx-auto md:mx-0 text-lg md:text-xl leading-relaxed">
                  Dedicated to building reliable software. I focus on precision
                  testing, automation, and ensuring a seamless experience for
                  every user.
                </Typography>
              </motion.div>
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  ...
                  <Button
                    ...
                    href="https://docs.google.com/document/d/1bpvw1HSTl7UMyP7sQxfhAWczFE9eGllE/edit?usp=sharing&ouid=105941702497305314039&rtpof=true&sd=true"
                    target="_blank"
                  >
                    View CV
                  </Button>
